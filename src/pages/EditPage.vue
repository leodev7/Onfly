          ...
          <q-item-section>
            ...
            <q-item-label>
              <div class="text-right q-gutter-sm">
                ...
                <q-btn color="dark" icon="save" label="Salvar" class="text-capitalize" @click="onUserEdit()" />
              </div>
            </q-item-label>
...
export default {
  ...
  methods: {
    ...
    onUserEdit () {
      ...
      this.$axios({ method: 'put', url: `https://gorest.co.in/public/v1/users/${this.userId}`, data: this.user, headers: { 'Authorization': 'Bearer d949591f556c81ec7595da23ade6a76d6ca39cedb4c88556b779001b64d1692a' } })
        .then((response) => {
